...
from src.core.interfaces.clients.tournament_balancer import TournamentBalancerClientProtocol


class TournamentBalancerClient(TournamentBalancerClientProtocol):
