...
from sqlalchemy import ForeignKey, func, Enum as AlchemyEnum
...
class Draft(Base):
    ...
    status: Mapped[DraftStatus] = mapped_column(AlchemyEnum(DraftStatus), default=DraftStatus.OPEN)
    ...
    drafted_players: Mapped[list["DraftedPlayer"]] = relationship("DraftedPlayer", back_populates="draft", lazy="raise")
