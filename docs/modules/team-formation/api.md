...
## Overview
- **Handler file:** `src/infra/rabbit/api/team_formation.py`
...
|-------|---------|--------|-------------|
| `event.team_formation.run` | `RunTeamFormationCommand` | `TeamFormationJob` | Запуск балансировки команд |
...
| `variants` | `list[TeamFormationVariant]` | Варианты распределения |
...
### Result: `TeamFormationJob`
Возвращает job с пагинированными variants.
