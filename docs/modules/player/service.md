...
## Method: `get_list(command: ListPlayersCommand) -> list[dict]`
...
4. `player_repo.list_by_event(event_id, offset, limit, status)` → маппинг в dict
...
## Method: `update_status(command: UpdatePlayerStatusCommand) -> dict`
